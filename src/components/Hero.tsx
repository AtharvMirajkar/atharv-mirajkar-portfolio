      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          >
            ...
            <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              Hi, I'm <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">Atharv Mirajkar</span>
            </h1>
            <p className={`text-base sm:text-lg lg:text-xl mb-6 sm:mb-8 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            >
              <motion.div 
                className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl p-4 sm:p-6 shadow-lg`}
                whileHover={{ scale: 1.02 }}
                transition={{ type: "spring", stiffness: 300 }}
              >
                <div className="flex items-center gap-3 mb-2 sm:mb-4">
                  <Briefcase className="text-purple-600 w-5 h-5 sm:w-6 sm:h-6" />
                  <h3 className={`text-base sm:text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Experience</h3>
                </div>
              ...
              >
                <div className="flex items-center gap-3 mb-2 sm:mb-4">
                  ...
                  <h3 className={`text-base sm:text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Education</h3>
                </div>
                <p className={`text-sm sm:text-base ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
              ...
              >
                <div className="flex items-center gap-3 mb-2 sm:mb-4">
                  ...
                  <h3 className={`text-base sm:text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>College</h3>
                </div>
                <p className={`text-sm sm:text-base ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
              ...
              >
                <div className="flex items-center gap-3 mb-2 sm:mb-4">
                  ...
                  <h3 className={`text-base sm:text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>CGPA</h3>
                </div>
                <p className={`text-sm sm:text-base ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  8.08
                </p>
