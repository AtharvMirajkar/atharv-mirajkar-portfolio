...
import { Code2, Layout, Database, Server, Palette, GitBranch } from 'lucide-react';
...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["Node.js", "Express.js", "RESTful APIs", "JWT", "Nodemailer", "Cron Jobs", "Stripe"]
  },
  {
    title: "Databases",
  ...
  },
  {
    ...
    skills: ["Git", "GitHub", "Jira","Postman", "VS Code", "Cursor", "Docker", "Vite"]
  }
];

const Skills = ({ darkMode }: SkillsProps) => {
  return (
    <section className={`py-20 ${darkMode ? 'bg-gray-900' : 'bg-white'}`} id="skills">
